...

 ...
 ; Berfungsi Untuk mengalanisa kelemahan dari Sistem Kali Linux
 ; anda hanya perlu memasukan koneksi internet dan port yang terbuka (usahakan 22)
 ; maka Sistem ini akan menyerang Linux dan memasukan shell gila otomatis
